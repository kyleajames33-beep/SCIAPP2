...
import { BossHpBar } from '../multiplayer/_components/boss-hp-bar'
import { DamagePopup } from '../multiplayer/_components/damage-popup'
import { BossVictory } from '../multiplayer/_components/boss-victory'
import { BattleArena } from '../multiplayer/_components/battle-arena'
              ...
              <AnimatePresence>
                {showXP && (
                  <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    className="absolute top-0 left-1/2 -translate-x-1/2 text-xl font-bold text-yellow-500 pointer-events-none z-50"
                  >
                    +10 XP
                  </motion.div>
                )}
