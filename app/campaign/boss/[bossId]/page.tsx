...
const BOSS_DATA: Record<string, { name: string; maxHp: number; element: string }> = {
  "boss-1": { name: "Acidic Slime", maxHp: 500, element: "Acids & Bases" },
  "boss-2": { name: "Oxidation Wraith", maxHp: 750, element: "Redox Reactions" },
  "boss-3": { name: "Polymer Golem", maxHp: 1000, element: "Organic Chemistry" },
  "boss-4": { name: "Equilibrium Specter", maxHp: 1250, element: "Chemical Equilibrium" },
  "boss-5": { name: "Nuclear Phoenix", maxHp: 1500, element: "Nuclear Chemistry" }
};
...
export default function BossBattlePage() {
  ...
  useEffect(() => {
    const bossInfo = BOSS_DATA[bossId];
    if (!bossInfo) {
